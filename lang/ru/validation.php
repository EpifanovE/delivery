...
return [
    ...
    */
    ...
    'ascii' => 'Поле :attribute должно содержать символы в кодировке ASCII.',
    ...
    'mac_address' => 'TПоле :attribute должно содержать корректный MAC адрес.',
    'max' => [
    ...
    'min_digits' => 'Поле :attribute должно содержать не менее :max цифр.',
    ...
    'password' => [
        ...
        'mixed' => 'Поле :attribute должно содержать хотя бы одну букву верхнем и одну букву в нижнем регистре.',
        'numbers' => 'Поле :attribute должно содержать хотя бы одну цифру.',
        'symbols' => 'Поле :attribute должно содержать хотя бы один символ.',
        'uncompromised' => 'Значение поля :attribute было скомпрометировано. Пожалуйста, выберите другое значение поля :attribute.',
    ],
    ...
    'required_if_accepted' => 'Поле :attribute является обязательным, когда принято поле :other.',
